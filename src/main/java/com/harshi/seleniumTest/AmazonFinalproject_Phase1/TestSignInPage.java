package com.harshi.seleniumTest.AmazonFinalproject_Phase1;
...
public class TestSignInPage {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("ap_email")).sendKeys("harshithaharshi027@gmail.com");
		driver.findElement(By.xpath("//input[@id='continue']")).click();
		
		// inspect password input box and click on sign button
		
		driver.findElement(By.id("ap_password")).sendKeys("Harshitha@7349207148$");
